...
namespace ModManager
{
    public static class CrossPromotionManager
    {
        ...
        private static Dictionary<PublishedFileId_t, AccountID_t> _authorForMod =
        ...
        private static Dictionary<AccountID_t, List<CrossPromotion>> _modsForAuthor =
        ...
        {
            get { return _cacheCount ??= new DirectoryInfo(CachePath).GetFiles().Length; }
        }
        ...
        {
            get { return _cacheSize ??= new DirectoryInfo(CachePath).GetFiles().Sum(f => f.Length); }
        }
