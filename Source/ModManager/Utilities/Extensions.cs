...
namespace ModManager {
    public static class Extensions {
        ...
        private static readonly Dictionary<ModMetaData, Mod> _modClassWithSettingsCache = new Dictionary<ModMetaData, Mod>();

        public static Mod ModClassWithSettings(this ModMetaData mod) {
            if (_modClassWithSettingsCache.TryGetValue(mod, out Mod modClass)) {
                return modClass;
            }
